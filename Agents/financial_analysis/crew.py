# -*- coding: utf-8 -*-
"""L6-style CrewAI crew: Data Analyst, Trading Strategy, Trade Advisor, Risk Advisor."""
...
def build_crew(verbose: bool = True) -> Crew:
    ...
    data_analyst = Agent(
        ...
        backstory=(
            "Specializing in financial markets, this agent uses statistical modeling and machine learning "
    ...
    trading_strategy = Agent(
        role="Trading Strategy Developer",
        goal="Develop and test various trading strategies based on insights from the Data Analyst Agent.",
        backstory=(
            "Equipped with a deep understanding of financial markets and quantitative analysis, this agent "
    ...
    execution_agent = Agent(
        ...
        backstory=(
            ...
            "By evaluating these factors, it provides well-founded suggestions for when and how trades should "
            "be executed to maximize efficiency and adherence to strategy."
        ),
        verbose=verbose,
        allow_delegation=True,
        tools=[scrape_tool, search_tool],
    ...
    risk_agent = Agent(
        ...
        backstory=(
            "Armed with a deep understanding of risk assessment models and market dynamics, this agent "
    ...
    risk_task = Task(
        description=(
            "Evaluate the risks associated with the proposed trading strategies and execution plans "
            "for {stock_selection}. Provide a detailed analysis of potential risks and suggest mitigation strategies."
        ),
        expected_output=(
    ...
    return Crew(
        agents=[data_analyst, trading_strategy, execution_agent, risk_agent],
        tasks=[data_analysis_task, strategy_task, execution_task, risk_task],
